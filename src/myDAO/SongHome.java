...
public class SongHome {
	...
	public Song merge(Song detachedInstance) {
		...
		try {
			Song result = (Song) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Song findById(java.lang.Integer id) {
		...
		try {
			Song instance = (Song) sessionFactory.getCurrentSession().get("myModel.Song", id);
			if (instance == null) {
	...
	public List<Song> findByExample(Song instance) {
		log.debug("finding Song instance by example");
		try {
			List<Song> results = (List<Song>) sessionFactory.getCurrentSession().createCriteria("myModel.Song")
